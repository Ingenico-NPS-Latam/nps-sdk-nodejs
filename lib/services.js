...
const GET_MERCH_DET_NOT_ADD_SERVICES = [
            QUERY_TXS,
            REFUND,
            SIMPLE_QUERY_TX,
            CAPTURE,
...
module.exports = {
    ...
    PAY_ONLINE_3P:PAY_ONLINE_3P,
    SPLIT_AUTHORIZE_3P:SPLIT_AUTHORIZE_3P,
    SPLIT_PAY_ONLINE_3P: SPLIT_PAY_ONLINE_3P,
    BANK_PAYMENT_2P: BANK_PAYMENT_2P,
    SPLIT_PAY_ONLINE_2P: SPLIT_PAY_ONLINE_2P,

...
SoapClient.prototype.addSecureHash = function(args, sKey){
    ...
    md5_hash = this.createMd5Hash(str, sKey);
    hmac_sha256_hash = this.createHmacSha256Hash(str, sKey);

    args.psp_SecureHash = md5_hash;
    return args; 
};
...
SoapClient.prototype.prepareRequest = function(args, config, service){
    ...
    console.log(service);
    console.log(services.GET_MERCH_DET_NOT_ADD_SERVICES.indexOf(service))
